...
train_set = myDataset(root='../Data/temp', transform_x=train_transform, flag='train')
valid_set = myDataset(root='../Data/temp', transform_x=test_tfm, flag='valid')
...
class_weight = torch.FloatTensor([1.5, 1]).to(device)
